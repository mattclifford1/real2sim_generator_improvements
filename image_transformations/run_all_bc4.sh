...
python image_transformations/eval_tranforms.py --trans rotation --min -50 --max 50 --steps $STEPS  --ram --dir $DIR &
python image_transformations/eval_tranforms.py --trans brightness --min -1 --max 1 --steps $STEPS --ram --dir $DIR &
python image_transformations/eval_tranforms.py --trans blur --min 0 --max 30 --steps 31 --ram --dir $DIR &
