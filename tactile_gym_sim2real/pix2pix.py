...
from tactile_gym_sim2real.utils import str2bool, save_json_obj, check_dir, clear_dir
...
def main(opt, augmentation_params, weights, task_dirs, data_dirs):
    ...
    save_dir_name = os.path.join(opt.dir, 'models', 'sim2real', 'alex-new','saved_models', task_str, image_size_str + "_" + dir_str + '_' + str(opt.epochs) + 'epochs' )
...
if __name__ == '__main__':
    ...
    main(opt, augmentation_params, weights, [opt.task[0]], [opt.task[1]])
