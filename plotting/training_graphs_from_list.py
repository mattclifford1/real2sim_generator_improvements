...
if __name__ == '__main__':
    ...
    curves_to_plot = {
        ...
        'edge tap': os.path.join('edge_2d', 'tap', pretrained, 'no_ganLR:0.001_decay:0.1_BS:64', 'run_0', 'training_stats.csv'),
        'edge tap GAN': os.path.join('edge_2d', 'tap', pretrained, 'GAN_LR:0.001_decay:0.1_BS:64', 'run_0', 'training_stats.csv'),
        'edge shear': os.path.join('edge_2d', 'shear', pretrained, 'no_ganLR:0.001_decay:0.1_BS:64', 'run_0', 'training_stats.csv'),
        'edge shear GAN': os.path.join('edge_2d', 'shear', pretrained, 'GAN_LR:0.001_decay:0.1_BS:64', 'run_0', 'training_stats.csv'),
        'surface tap': os.path.join('surface_3d', 'tap', pretrained, 'no_ganLR:0.001_decay:0.1_BS:64', 'run_0', 'training_stats.csv'),
        'surface tap GAN': os.path.join('surface_3d', 'tap', pretrained, 'GAN_LR:0.001_decay:0.1_BS:64', 'run_0', 'training_stats.csv'),
        'surface shear': os.path.join('surface_3d', 'shear', pretrained, 'no_ganLR:0.001_decay:0.1_BS:64', 'run_0', 'training_stats.csv'),
        'surface shear GAN': os.path.join('surface_3d', 'shear', pretrained, 'GAN_LR:0.001_decay:0.1_BS:64', 'run_0', 'training_stats.csv'),
    }
